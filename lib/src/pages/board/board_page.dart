...
//             body: Padding(
//               padding: EdgeInsets.symmetric(horizontal: isMobile ? l(20) : l(32)),
...
//     return Builder(
//       builder: (_) {
//         List<BoardCardV1> boards = getBoardFromMD(widget.data);
//         return Scrollbar(
//           child: SingleChildScrollView(
...
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
//                 for (BoardCardV1 board in boards)
//                   Padding(
...
//                                     BoardItemV1 item = board.items[i];
//                                     return Container(
//                                       decoration: BoxDecoration(
//                                         color: surface,
